...
import {createFeatureAwareFactory} from "./featureFactory";
...
class InterfacePrototype {
    ...
    async startInit () {
        ...
        const factory = createFeatureAwareFactory(this.globalConfig, this.settings.featureToggles);
        factory.createFormSubmissionsFeature(this.scanner);
    }
