...
class AppleOverlayDeviceInterface extends _AppleDeviceInterface.AppleDeviceInterface {
  ...
  async setupAutofill() {
    ...
    const overlay = (0, _overlayApi.overlayApi)(this);
...
},{"../../packages/device-api/index.js":10,"../UI/controllers/HTMLTooltipUIController.js":49,"./AppleDeviceInterface.js":20,"./overlayApi.js":26}],22:[function(require,module,exports){
"use strict";
...
class InterfacePrototype {
  ...
  _detectFormSubmission(event) {
    ...
    matchingForm === null || matchingForm === void 0 ? void 0 : matchingForm.submitHandler('_detectFormSubmission');
...
},{"../../packages/device-api/index.js":10,"../Form/formatters.js":30,"../Form/listenForFormSubmission.js":34,"../Form/matching.js":37,"../Form/selectors-css.js":38,"../InputTypes/Credentials.js":40,"../PasswordGenerator.js":43,"../Scanner.js":44,"../Settings.js":45,"../UI/controllers/NativeUIController.js":50,"../autofill-utils.js":57,"../config.js":59,"../deviceApiCalls/__generated__/deviceApiCalls.js":61,"../deviceApiCalls/transports/transports.js":67}],24:[function(require,module,exports){
"use strict";
...
class WindowsOverlayDeviceInterface extends _InterfacePrototype.default {
  ...
  createUIController() {
    return new _HTMLTooltipUIController.HTMLTooltipUIController({
      ...
      /**
       * Note: This is needed because certain
       */
...
},{"../UI/controllers/HTMLTooltipUIController.js":49,"../deviceApiCalls/__generated__/deviceApiCalls.js":61,"./InterfacePrototype.js":23,"./overlayApi.js":26}],26:[function(require,module,exports){
"use strict";
...
function overlayApi(device) {
  return {
    _setupTopFrame() {
      ...
      const tooltip = (_device$uiController$ = (_device$uiController = device.uiController).createTooltip) === null || _device$uiController$ === void 0 ? void 0 : _device$uiController$.call(_device$uiController, getPosition, topContextData);

      if (tooltip) {
        var _device$uiController$2, _device$uiController2;

        (_device$uiController$2 = (_device$uiController2 = device.uiController).setActiveTooltip) === null || _device$uiController$2 === void 0 ? void 0 : _device$uiController$2.call(_device$uiController2, tooltip);
      }
    },
    ...
    async setSize(details) {
      await device.deviceApi.notify(new _deviceApiCalls.SetSizeCall(details));
    }

  };
}

},{"../deviceApiCalls/__generated__/deviceApiCalls.js":61}],27:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils.js":57,"../constants.js":60,"./FormAnalyzer.js":28,"./formatters.js":30,"./inputStyles.js":31,"./inputTypeConfig.js":32,"./matching.js":37}],28:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils.js":57,"../constants.js":60,"./matching-configuration.js":36,"./matching.js":37}],29:[function(require,module,exports){
"use strict";
...
},{"./countryNames.js":29,"./matching.js":37}],31:[function(require,module,exports){
"use strict";
...
},{"./inputTypeConfig.js":32}],32:[function(require,module,exports){
"use strict";
...
},{"../InputTypes/Credentials.js":40,"../InputTypes/CreditCard.js":41,"../InputTypes/Identity.js":42,"../UI/img/ddgPasswordIcon.js":53,"./logo-svg.js":35,"./matching.js":37}],33:[function(require,module,exports){
"use strict";
...
},{"./matching.js":37}],34:[function(require,module,exports){
"use strict";
...
const listenForGlobalFormSubmission = forms => {
  try {
    window.addEventListener('submit', e => {
      ...
      return (// @ts-ignore
        (_forms$get = forms.get(e.target)) === null || _forms$get === void 0 ? void 0 : _forms$get.submitHandler('global submit event')
      );
    }, true);
    window.addEventListener('keydown', e => {
      if (e.key === 'Enter') {
        const focusedForm = [...forms.values()].find(form => form.hasFocus(e));
        focusedForm === null || focusedForm === void 0 ? void 0 : focusedForm.submitHandler('keydown + Enter');
      }
    });
...
},{"../constants.js":60,"./label-util.js":33,"./matching-configuration.js":36,"./selectors-css.js":38,"./vendor-regex.js":39}],38:[function(require,module,exports){
"use strict";
...
},{"../Form/formatters.js":30}],43:[function(require,module,exports){
"use strict";
...
},{"./Form/Form.js":27,"./Form/matching.js":37,"./Form/selectors-css.js":38,"./autofill-utils.js":57}],45:[function(require,module,exports){
"use strict";
...
class Settings {
  ...
  async _getRuntimeConfiguration() {
    ...
    if (!runtimeConfig) throw new Error('runtime configuration not found');
  ...
  async refresh(availableInputTypesOverrides) {
    this.setEnabled(await this.getEnabled()); // if we determined that
...
class HTMLTooltipUIController extends _UIController.UIController {
  ...
  constructor(options) {
    ...
    window.addEventListener('mouseMove', event => {
      ...
      const activeTooltip = (_this$getActiveToolti = this.getActiveTooltip) === null || _this$getActiveToolti === void 0 ? void 0 : _this$getActiveToolti.call(this);
...
},{"../../Form/inputTypeConfig.js":32,"../DataHTMLTooltip.js":46,"../EmailHTMLTooltip.js":47,"../HTMLTooltip.js":48,"./UIController.js":52}],50:[function(require,module,exports){
"use strict";
...
const getAutofillInitDataResponseSchema = _zod.z.object({
  ...
  success: _zod.z.object({
    ...
    identities: _zod.z.array(_zod.z.record(_zod.z.any())),
    creditCards: _zod.z.array(_zod.z.record(_zod.z.any())),
...
},{"../../../packages/device-api/index.js":10,"../../appleDeviceUtils/appleDeviceUtils.js":55,"../__generated__/deviceApiCalls.js":61}],66:[function(require,module,exports){
"use strict";
