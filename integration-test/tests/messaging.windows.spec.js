...
test.describe('Windows secure messaging', () => {
    ...
    test.describe('When autofill script runs', () => {
        test('the window.chrome.webview variables have been removed', async ({page}) => {
            ...
            // this part ensures that we actually have a `window.chrome.webview.postMessage` initially
            // this is here to prevent the possible false positive in the next assertion - because if
