...
},{"./DeviceInterface/AndroidInterface":2,"./DeviceInterface/AppleDeviceInterface":3,"./DeviceInterface/ExtensionInterface":4,"./autofill-utils":25}],2:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils":25,"../scanForInputs.js":30,"./InterfacePrototype.js":5}],3:[function(require,module,exports){
"use strict";
...
},{"../appleDeviceUtils/appleDeviceUtils":23,"../autofill-utils":25,"../scanForInputs.js":30,"./InterfacePrototype.js":5}],4:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils":25,"../scanForInputs.js":30,"./InterfacePrototype.js":5}],5:[function(require,module,exports){
"use strict";
...
},{"../Form/formatters":9,"../UI/DataAutofill":18,"../UI/EmailAutofill":19,"../autofill-utils":25,"../scanForInputs":30}],6:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils":25,"../constants":27,"./FormAnalyzer":7,"./formatters":9,"./inputStyles":10,"./inputTypeConfig.js":11,"./matching":15,"./matching-configuration":14}],7:[function(require,module,exports){
"use strict";
...
},{"../constants":27,"./matching":15,"./matching-configuration":14}],8:[function(require,module,exports){
"use strict";
...
},{"./countryNames":8,"./matching":15}],10:[function(require,module,exports){
"use strict";
...
},{"../UI/img/ddgPasswordIcon":21,"../autofill-utils":25,"./formatters":9,"./logo-svg":13,"./matching":15}],12:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils":25,"../scanForInputs":30}],13:[function(require,module,exports){
"use strict";
...
const matchingConfiguration = {
    ...
    fields: {
      ...
      firstName: {
        ...
        strategies: [{
          ...
          kind: 'ddg-matcher',
          matcherName: 'firstName'
        }, {
          kind: 'vendor-regex',
          regexName: 'given-name'
        }]
      },
      middleName: {
        type: 'middleName',
        strategies: [{
          kind: 'css-selector',
          selectorName: 'middleName'
        }, {
          kind: 'ddg-matcher',
          matcherName: 'middleName'
        }, {
          kind: 'vendor-regex',
          regexName: 'additional-name'
        }]
      },
      lastName: {
        type: 'lastName',
        strategies: [{
          ...
          kind: 'ddg-matcher',
          matcherName: 'lastName'
        }, {
          kind: 'vendor-regex',
          regexName: 'family-name'
        }]
      },
      fullName: {
        type: 'fullName',
      ...
      addressStreet: {
        ...
        strategies: [{
          kind: 'css-selector',
          selectorName: 'addressStreet'
        }, {
          kind: 'ddg-matcher',
          matcherName: 'addressStreet'
        }, {
          kind: 'vendor-regex',
          regexName: 'address-line1'
        }]
      },
      addressStreet2: {
        type: 'addressStreet2',
        strategies: [{
          kind: 'css-selector',
          selectorName: 'addressStreet2'
        }, {
          kind: 'ddg-matcher',
          matcherName: 'addressStreet2'
        }, {
          kind: 'vendor-regex',
          regexName: 'address-line2'
        }]
      },
      addressCity: {
        type: 'addressCity',
        strategies: [{
          kind: 'css-selector',
          selectorName: 'addressCity'
        }, {
          kind: 'ddg-matcher',
          matcherName: 'addressCity'
        }, {
          kind: 'vendor-regex',
          regexName: 'address-level2'
        }]
      },
      addressProvince: {
        ...
        strategies: [{
          kind: 'css-selector',
          selectorName: 'addressProvince'
        }, {
          kind: 'ddg-matcher',
          matcherName: 'addressProvince'
        }, {
          kind: 'vendor-regex',
          regexName: 'address-level1'
        }]
      },
      addressPostalCode: {
        ...
        strategies: [{
          kind: 'css-selector',
          selectorName: 'addressPostalCode'
        }, {
          kind: 'ddg-matcher',
          matcherName: 'addressPostalCode'
        }, {
          kind: 'vendor-regex',
          regexName: 'postal-code'
        }]
      },
      addressCountryCode: {
        ...
        strategies: [{
          kind: 'css-selector',
          selectorName: 'addressCountryCode'
        }, {
          kind: 'ddg-matcher',
          matcherName: 'addressCountryCode'
        }, {
          kind: 'vendor-regex',
          regexName: 'country'
        }]
      ...
      cardName: {
        ...
        strategies: [{
          kind: 'css-selector',
          selectorName: 'cardName'
        }, {
          kind: 'ddg-matcher',
          matcherName: 'cardName'
        }, {
          kind: 'vendor-regex',
          regexName: 'cc-name'
        }]
      ...
      cardNumber: {
        ...
        strategies: [{
          kind: 'css-selector',
          selectorName: 'cardNumber'
        }, {
          kind: 'ddg-matcher',
          matcherName: 'cardNumber'
        }, {
          kind: 'vendor-regex',
          regexName: 'cc-number'
        }]
      ...
      cardSecurityCode: {
        ...
        strategies: [{
          kind: 'css-selector',
          selectorName: 'cardSecurityCode'
        }, {
          kind: 'ddg-matcher',
          matcherName: 'cardSecurityCode'
        }]
      },
      expirationMonth: {
        ...
        strategies: [{
          kind: 'css-selector',
          selectorName: 'expirationMonth'
        }, {
          kind: 'ddg-matcher',
          matcherName: 'expirationMonth'
        }, {
          kind: 'vendor-regex',
          regexName: 'cc-exp-month'
        }]
      },
      expirationYear: {
        type: 'expirationYear',
        strategies: [{
          kind: 'css-selector',
          selectorName: 'expirationYear'
        }, {
          kind: 'ddg-matcher',
          matcherName: 'expirationYear'
        }, {
          kind: 'vendor-regex',
          regexName: 'cc-exp-year'
        }]
      },
      expiration: {
        type: 'expiration',
  ...
  'vendor-regexes': {
    ...
    // [1] https://source.chromium.org/chromium/chromium/src/+/master:components/autofill/core/common/autofill_regex_constants.cc
    {
      ...
      // ko-KR
      // ==== Address Fields ====
      organization: 'company|business|organization|organisation' + // '|(?<!con)firma|firmenname' + // de-DE // // todo: not supported in safari
      '|empresa' + // es
      ...
      'address-line1': '^address$|address[_-]?line(one)?|address1|addr1|street' + '|(?:shipping|billing)address$' + '|strasse|straße|hausnummer|housenumber' + // de-DE
      '|house.?name' + // en-GB
...
},{"./selectors-css":16}],15:[function(require,module,exports){
"use strict";
...
var _vendorRegExpRules = new WeakMap();

var _vendorRegExp = new WeakMap();

var _cssSelectors = new WeakMap();

var _ddgMatchers = new WeakMap();

var _matcherLists = new WeakMap();
...
class Matching {
  ...
  constructor(config) {
    ...
    _vendorRegExpRules.set(this, {
      writable: true,
      value: void 0
    });

    _vendorRegExp.set(this, {
      writable: true,
      value: void 0
    });
    ...
    _classPrivateFieldSet(this, _vendorRegExpRules, _classPrivateFieldGet(this, _config)['vendor-regexes']['regexes']);

    _classPrivateFieldSet(this, _vendorRegExp, createCacheableVendorRegexes(_classPrivateFieldGet(this, _vendorRegExpRules)));

    _classPrivateFieldSet(this, _cssSelectors, _classPrivateFieldGet(this, _config)['css-selectors'].selectors);

    _classPrivateFieldSet(this, _ddgMatchers, _classPrivateFieldGet(this, _config)['ddg-matchers'].matchers);
    ...
    Object.keys(_classPrivateFieldGet(this, _config).matchers.lists).forEach(key => {
      const list = _classPrivateFieldGet(this, _config).matchers.lists[key];

      for (let fieldName of list) {
        _classPrivateFieldGet(this, _matcherLists)[key].push(_classPrivateFieldGet(this, _config).matchers.fields[fieldName]);
      }
    });
  }
  /**
  ...
  vendorRegex(regexName) {
    const match = _classPrivateFieldGet(this, _vendorRegExp).RULES[regexName];
  ...
  execDDGMatcher(ddgMatcher, el, form) {
    for (let elementString of this.getElementStrings(el, form)) {
      ...
      let matchRexExp = new RegExp(ddgMatcher.match || '', 'u'); // if the `match` regex fails, moves onto the next
...
},{"../constants":27,"./selectors-css":16,"./vendor-regex":17}],16:[function(require,module,exports){
"use strict";
...
},{"../Form/inputTypeConfig":11,"../Form/matching":15,"../autofill-utils":25,"./Tooltip":20,"./styles/autofill-tooltip-styles.js":22}],19:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils":25,"./Tooltip":20,"./styles/autofill-tooltip-styles.js":22}],20:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils":25}],21:[function(require,module,exports){
"use strict";
...
},{"./captureDdgGlobals":24}],24:[function(require,module,exports){
"use strict";
...
},{"./Form/matching":15}],26:[function(require,module,exports){
"use strict";
...
},{"./Form/listenForFormSubmission":12,"./inject":28}],27:[function(require,module,exports){
"use strict";
...
},{"./DeviceInterface":1,"./autofill-utils":25,"./requestIdleCallback":29,"./scanForInputs":30}],29:[function(require,module,exports){
"use strict";
...
},{"./Form/Form":6,"./Form/selectors-css":16,"./autofill-utils":25}]},{},[26]);
